                                ...
                                <div class="col-md-6">
                                    <form action="code.php" method="POST">
                                        <div class="form-group">
                                            <input type="text" name="newService" class="form-control" placeholder="Enter New Service">
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" name="addservice" class="btn btn-primary">Add New Service</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
